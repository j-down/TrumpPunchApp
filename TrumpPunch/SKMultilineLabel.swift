...
class SKMultilineLabel: SKNode {
    ...
    init(text:String, labelWidth:Int, pos:CGPoint, fontName:String="Helvetica",fontSize:CGFloat=20,fontColor:SKColor=SKColor.black,leading:Int=20, alignment:SKLabelHorizontalAlignmentMode = .center, shouldShowBorder:Bool = false)
    {
        self.text = text
